...
# install R packages
R --slave -e 'install.packages(c("getopt", "optparse", "ggplot2", "RColorBrewer"), repos="https://cloud.r-project.org")'
```
...
```
This will generate a result file `aln.paf.pdf` and `aln.paf.png` in the current directory. You can use [ImageMagick](https://github.com/ImageMagick/ImageMagick) command to do some format conversion or modification.
...
* Version 1.0.2 (2026.04.24):
  - Added PNG output together with PDF output by default, [#6](https://github.com/moold/paf2dotplot/issues/6#issue-4321522273) (Thanks to @KewinOgink)
